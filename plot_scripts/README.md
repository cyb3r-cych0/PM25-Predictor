...
`models_pred_vs_obs_supp_plots.py`| Observation plotting script for additional diagnostics | Generates supplementary figures like grid plots and individual model plots |
`models_bias_trend_timeseries.py` | Generated Residual Plots
...
1. **Trend Plots**:
   ...
   `python ../plot_sctipts/models_actual_vs_pred_trends_plots.py`
...
2. **Observation Plots**:
   ...
   `python ../plot_sctipts/models_pred_vs_obs_supp_plots.py`
   
   - Creates additional diagnostic plots (e.g., combined grids, individual model visuals)

3. **Residual trend Timeseries**:

   `python ../plot_sctipts/models_bias_trend_timeseries.py`

   - Generates residual timeseriesplots
